...
$dts = DateTime::Schedule::Weekly->new(sunday => 1, monday => 0, tuesday => 0, wednesday => 0, thursday => 0, friday => 0, saturday => 0);
...
ok(dies { DateTime::Schedule::Weekly->new(sunday => 0, monday => 0, tuesday => 0, wednesday => 0, thursday => 0, friday => 0, saturday => 0) }, 'must have at least one day scheduled');
